...
public class WeatherReportUtil {
	...
	public Weather getWeatherReport(String cityN) throws Exception {
        ...
        parameters.add("location=" + URLEncoder.encode(cityN, "UTF-8"));
        ...
        HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create(url + "?location="+cityN+"&format=json"))
